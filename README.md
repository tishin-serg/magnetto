...
| MGB-13 | Исправлено удаление отдельных файлов из медиатеки домашнего ПК: WebDAV больше не получает повторно закодированные пути. Добавлен regression-тест для вложенных путей с пробелами и кириллицей. |
