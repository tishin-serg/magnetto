...
| MGB-12 | Первые 15 минут загрузки: порог скорости, три последовательных замера, персистентный монитор, сохранённые альтернативы и ручная/автоматическая замена без удаления данных. |
